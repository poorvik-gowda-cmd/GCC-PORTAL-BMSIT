...
- Name: events.spec.ts >> Event Registration & Bot Guard E2E Suite >> should reject event registration with invalid turnstile token
- Location: tests\e2e\events.spec.ts:11:7
