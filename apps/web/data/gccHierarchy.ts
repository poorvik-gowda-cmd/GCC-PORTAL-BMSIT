...
export const GCC_DEPARTMENTS: HierarchyDepartment[] = [
    ...
    members: [
      {
        ...
        photo: "/images/logo/members/khushi.png",
        intro: "Assisting in the planning, coordination, and seamless execution of world-class events for the Global Collaboration Cell.",
        social: {},
      },
      {
        id: "events-sulochana",
        ...
        photo: "/images/logo/members/sulochana.png",
        intro: "Coordinating event operations and logistics to ensure seamless execution and impactful experiences across GCC events.",
        social: {},
      },
      {
        id: "events-syed",
  ...
  // 3. MARKETING & OUTREACH  |  SIGMA PI
  {
    ...
    members: [
      ...
      {
        id: "marketing-varshini",
        name: "Varshini B S",
        role: "Outreach Associate",
        photo: "/images/logo/members/varshini.png",
        intro: "Driving outreach initiatives and expanding GCC's community presence and partnerships through impactful marketing and communication.",
        social: {},
      },
      {
        id: "marketing-pratyush",
        name: "Pratyush Chauhan",
        role: "Marketing Associate",
        photo: "/images/logo/members/pratyush.png",
        intro: "Driving marketing and outreach strategies to expand GCC's reach, branding, and student engagement.",
        social: {},
      },
    ],
  },
  ...
  // 5. SOCIAL MEDIA, INNOVATION & DIGITAL INTEGRATION  |  OMEGA PSI
  {
    ...
    members: [
      ...
      },
      {
        ...
        role: "Social Media Associate",
        photo: "/images/logo/members/varshini.png",
        intro: "Contributing to GCC's digital and social media innovation strategies, engaging student communities across platforms.",
        social: {},
      },
      {
        id: "social-pratyush",
        ...
        role: "Social Media Associate",
        photo: "/images/logo/members/pratyush.png",
        intro: "Creating engaging content and contributing to innovative digital strategies across GCC's social platforms.",
        social: {},
      },
    ],
  },
